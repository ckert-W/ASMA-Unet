...
from models.MIMOTeansformUnet import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MIMO-Transform-UNET', choices=['MIMO-UNet', 'MIMO-UNetPlus','MIMO-Transform-UNET'], type=str)
